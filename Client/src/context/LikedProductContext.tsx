...
export const LikedProductsContext = createContext<LikedProductContextType | undefined>(undefined);

export default function LikedProductsProvider({ children }: { children: React.ReactNode }) {
    ...
    return (
        <LikedProductsContext.Provider value={{ likedProducts, likedProductsArray, isLiked, resetLikedArr, initializeLikedArray }}>
            {children}
